...
function TitleScreen() {
    ...
    this.doResizeUpdate = function () {
        var a;
        oSTAGE.is_landscape ? (a = Math.max(.5 * c.clientWidth, .33 * oSTAGE.wrapper_width) | 0, r.style.left = (a - .5 * r.clientWidth | 0) + "px", l.style.right = (.5 * (oSTAGE.wrapper_width - (r.offsetLeft + r.clientWidth)) - .5 * l.clientWidth | 0) + "px", r.style.bottom = "58px", l.style.bottom = "58px") : (a = .5 * oSTAGE.wrapper_width, r.style.left = "24px", l.style.right = "24px", r.style.bottom = "80px", l.style.bottom = "80px");
...
function RecapScreen() {
    ...
    this.doResizeUpdate = function () {
        var a;
        a = oSTAGE.is_landscape ? Math.max(.5 * f.clientWidth, .33 * oSTAGE.wrapper_width) : .5 * oSTAGE.wrapper_width;
